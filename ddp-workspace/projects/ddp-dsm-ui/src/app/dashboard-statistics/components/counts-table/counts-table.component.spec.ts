...
describe('CountsTableComponent',  () => {
  ...
  it('should sort by Count', async () => {
    ...
    const {title, count}: Partial<ICount> = await firstRow.getCellTextByColumnName();
  ...
  it('should sort by Title', async () => {
    ...
    const {title, count}: Partial<ICount> = await secondRow.getCellTextByColumnName();
