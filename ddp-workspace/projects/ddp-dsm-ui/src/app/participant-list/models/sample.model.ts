...
export class Sample {
  ...
  constructor(public bspCollaboratorSampleId: string, public kitType: string, public scanDate: number, public error: boolean,
              ...
              public trackingNumberReturn: string, public kitLabel: string, public testResult: Array<TestResult>,
  ...
  static parse(json): Sample {
    ...
    return new Sample(
      ...
      json.trackingNumberTo, json.trackingNumberReturn, json.kitLabel, testResults, json.upsTrackingStatus,
