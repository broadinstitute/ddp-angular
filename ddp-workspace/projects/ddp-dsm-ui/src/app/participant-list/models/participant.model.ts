export class ParticipantDSMInformation {
  ...
  constructor(public participantId: string, public ddpParticipantId: string, public realm: string,
               public assigneeMr: string, public assigneeTissue: string, public createdOncHistory: string,
              public reviewedOncHistory: string, public paperCRSent: string, public paperCRReceived: string,
              public ptNotes: string, public minimalMR: boolean, public abstractionReady: boolean,
               public mrNeedsAttention: boolean, public tissueNeedsAttention: boolean, public exitDate: number,
  ...
  static parse(json): ParticipantDSMInformation {
    ...
    return new ParticipantDSMInformation(
      json.participantId, json.ddpParticipantId, json.realm, json.assigneeMr, json.assigneeTissue,
      json.createdOncHistory, json.reviewedOncHistory, json.paperCRSent, json.paperCRReceived,
      json.ptNotes, json.minimalMR, json.abstractionReady, json.mrNeedsAttention, json.tissueNeedsAttention,
      json.exitDate, additionalValues
    );
  }
}
