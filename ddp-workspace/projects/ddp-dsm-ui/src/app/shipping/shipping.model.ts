...
export class KitRequest {
  constructor(public participantId: string, public collaboratorParticipantId: string, public bspCollaboratorSampleId: string,
              ...
              public receiveDateString: string, public hruid: string, public gender: string, public collectionDate: string, public firstName?: string, public lastName?: string, public dateOfBirth?: string, public shortId?: string) {
  }
  ...
  static parse(json): KitRequest {
    return new KitRequest(
      ...
      json.preferredLanguage, json.receiveDateString, json.hruid, json.gender, json.collectionDate, json.firstName, json.lastName, json.dateOfBirth, json.shortId
    );
  }
