export class Question {
  ...
  constructor(
    public qDate: string, public qUser: string, public email: string, public question: string,
    public status: string, public aDate: string, public answer: string, public del: boolean
  ) {
    this.qDate = qDate;
    this.qUser = qUser;
    this.email = email;
