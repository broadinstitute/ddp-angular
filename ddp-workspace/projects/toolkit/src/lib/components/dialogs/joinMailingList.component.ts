...
import { MailingListServiceAgent, AnalyticsEventsService, CompositeDisposable, Person, AnalyticsEvents } from 'ddp-sdk';
...
export class JoinMailingListComponent implements OnInit, OnDestroy {
    ...
    public submitForm(): void {
        ...
        this.analytics.emitCustomEvent(AnalyticsEvents.MailingList, AnalyticsEvents.Join);
