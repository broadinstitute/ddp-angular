...
import {WindowRef, AnalyticsEventsService, AnalyticsEventCategories, AnalyticsEventActions, SessionMementoService} from 'ddp-sdk';
...
export class WelcomeComponent implements OnInit {
    ...
    public scrollToStepsSection(): void {
        const top =
            this.scrollAnchor.nativeElement.getBoundingClientRect().top +
            window.scrollY -
    ...
    public sendCountMeInAnalytics(): void {
        this.analytics.emitCustomEvent(
            ...
            AnalyticsEventActions.FromMainPage
        );
    }

    private get getRealHeaderHeight(): number {
        return (
            this.HEADER_HEIGHT_REM *
