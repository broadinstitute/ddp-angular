    ...
    <div class="Wrapper">
        ...
        <div class="row">
            ...
            <section class="Message col-lg-6 col-lg-offset-3 col-md-8 col-md-offset-2 col-sm-8 col-sm-offset-2 col-xs-10 col-xs-offset-1 NoPadding">
                ...
                <div class="row">
                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 Message-partners">
                        <a href="http://www.degregorio.org/" target="_blank"><img class="partner-logo" lazy-resource src="/assets/images/degregorio-family-foundation.jpg" alt="DeGregorio Family Foundation logo"></a>
                    </div>
                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 Message-partners">
