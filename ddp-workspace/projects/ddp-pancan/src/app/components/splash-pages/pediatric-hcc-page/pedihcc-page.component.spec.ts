...
import { PediaHCCPageComponent } from './pediahcc-page.component';
...
describe('ColorectalPageComponent', () => {
    let component: PediaHCCPageComponent;
    let fixture: ComponentFixture<PediaHCCPageComponent>;
    ...
    beforeEach(() => {
        fixture = TestBed.createComponent(PediaHCCPageComponent);
