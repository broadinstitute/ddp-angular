...
@Component({
  ...
  template: `
    <footer class="Footer row">
      ...
      <div class="col-lg-8 col-md-8 col-sm-8 col-xs-12 Footer-links">
        <p class="Footer-text Float--right">
          ...
          <a [routerLink]="['/privacy-policy']" class="Footer-link" translate>Toolkit.Footer.PrivacyPolicy</a>
          <button (click)="goToTop()" class="Footer-link">
            <i class="fas fa-arrow-up Footer-arrow"></i>
            <span translate>Toolkit.Footer.BackToTop</span>
          </button>
        </p>
      </div>
    </footer>
