...
@Component({
    ...
    template: ` <ng-container *ngIf="block.shown">
        <ddp-activity-boolean-answer
            *ngIf="isBooleanQuestion(block)"
        ...
        <ddp-activity-numeric-answer
            *ngIf="isNumericQuestion(block) || isDecimalQuestion(block)"
        ...
        <ddp-activity-composite-answer
            *ngIf="isCompositeQuestion(block)"
        ...
        <ddp-activity-agreement-answer
            *ngIf="isAgreementQuestion(block)"
            [block]="block"
            [readonly]="readonly"
            (valueChanged)="onChange($event)"
        >
        ...
        <ddp-activity-instance-select-answer
            *ngIf="isActivityInstanceSelectQuestion(block)"
        ...
        ></ddp-activity-instance-select-answer>
        <span
            *ngIf="block.additionalInfoFooter"
...
export class ActivityAnswerComponent implements OnInit {
    ...
    public isBooleanQuestion(block: AbstractActivityQuestionBlock): boolean {
        return (
            ...
            block.questionType === QuestionType.Boolean
        );
    }

    public isTextQuestion(block: AbstractActivityQuestionBlock): boolean {
        return (
            this.isQuestion(block) && block.questionType === QuestionType.Text
        );
    }
    ...
    public isNumericQuestion(block: AbstractActivityQuestionBlock): boolean {
        return (
            this.isQuestion(block) &&
            block.questionType === QuestionType.Numeric
        );
    }
    ...
    public isDecimalQuestion(block: AbstractActivityQuestionBlock): boolean {
        return (
            this.isQuestion(block) &&
            block.questionType === QuestionType.Decimal
        );
    }
    ...
    public isPicklistQuestion(block: AbstractActivityQuestionBlock): boolean {
        return (
            this.isQuestion(block) &&
            block.questionType === QuestionType.Picklist
        );
    }

    public isDateQuestion(block: AbstractActivityQuestionBlock): boolean {
        return (
            this.isQuestion(block) && block.questionType === QuestionType.Date
        );
    }
    ...
    public isCompositeQuestion(block: AbstractActivityQuestionBlock): boolean {
        return (
            this.isQuestion(block) &&
            block.questionType === QuestionType.Composite
        );
    }
    ...
    public isAgreementQuestion(block: AbstractActivityQuestionBlock): boolean {
        return (
            this.isQuestion(block) &&
            block.questionType === QuestionType.Agreement
        );
    }

    public isFileQuestion(block: AbstractActivityQuestionBlock): boolean {
        return (
            this.isQuestion(block) && block.questionType === QuestionType.File
        );
    }

    public isMatrixQuestion(block: AbstractActivityQuestionBlock): boolean {
        return (
            this.isQuestion(block) && block.questionType === QuestionType.Matrix
        );
    }

    public isActivityInstanceSelectQuestion(
        block: AbstractActivityQuestionBlock
    ): boolean {
        return (
            this.isQuestion(block) &&
            block.questionType === QuestionType.ActivityInstanceSelect
        );
    }
