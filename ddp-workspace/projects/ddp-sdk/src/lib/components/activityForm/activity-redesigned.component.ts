    ...
    template: `
        ...
        <ng-template #navigationButtons>
            ...
            <button *ngIf="!isLastStep"
                    [disabled]="(isPageBusy | async) || dataEntryDisabled"
                    class="button button_medium  button_right next_button"
                    [ngClass]="isVerticalProgress? 'button_secondary' : 'button_primary'"
                    (click)="incrementStep()"
        ...
        <ng-template #lastStepButtons>
            <button *ngIf="!isReadonly() && !isAgree()" #submitButton
                    [disabled]="(isPageBusy | async) || dataEntryDisabled"
                    class="button button_medium button_right submit_button"
                    [ngClass]="isVerticalProgress? 'button_secondary' : 'button_primary'"
                    (click)="flush()"
