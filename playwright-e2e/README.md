...
- Checking new or/and modified Playwright tests pass. 
  - Trigger Playwright tests workflow `run-e2e-test` by `build-utils/run_ci.sh`
    ...
    ```
    cd build-utils
    ./run_ci.sh  run-e2e-test <STUDY_NAME> <GITHUB_BRANCH_NAME>
    ```
