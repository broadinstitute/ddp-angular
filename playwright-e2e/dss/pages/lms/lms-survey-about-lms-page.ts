...
export default class LmsSurveyAboutLmsPage extends LmsPageBase {
  constructor(page: Page, private typePatient: TypePatient = 'adult') {
    super(page);
  }

  async waitForReady(): Promise<void> {
    await expect(this.page.locator('h1.activity-header')).toHaveText(PatientsData[this.typePatient].surveyForm);
