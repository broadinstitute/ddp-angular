...
export default class AtcpMedicalHistoryPage extends AtcpPageBase {
  ...
  get siblingsATDiagnosis(): Question {
    return new Question(this.page, { cssClassAttribute: '.picklist-answer-DIAGNOSIS_PICKLIST', parentSelector: this.page.locator('.ddp-answer-field') });
  }
  ...
  get siblingsATCarrier(): Question {
    return new Question(this.page, { cssClassAttribute: '.picklist-answer-CARRIER_PICKLIST', parentSelector: this.page.locator('.ddp-answer-field') });
  }
