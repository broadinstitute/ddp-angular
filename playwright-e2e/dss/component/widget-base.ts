...
export default abstract class WidgetBase implements WidgetInterface {
  ...
  errorMessage(): Locator {
    return this.toLocator().locator(
      'xpath=/ancestor::ddp-activity-question//*[contains(@class,"ErrorMessage")] | /ancestor::mat-form-field//mat-error | //mat-error'
    );
  }
  ...
  async isDisabled(disabledAttribute = 'disabled'): Promise<boolean> {
    return (await this.toLocator().getAttribute(disabledAttribute)) !== null;
  }
