...
export enum Label {
  ...
  FAMILY_HISTORY_FEMALE_PARENT_SURVEY_COMPLETED = 'FAMILY_HISTORY_SELF_PARENT1 Survey Completed',
  FAMILY_HISTORY_FEMALE_PARENT_SURVEY_CREATED = 'FAMILY_HISTORY_SELF_PARENT1 Survey Created',
  FAMILY_HISTORY_FEMALE_PARENT_SURVEY_LAST_UPDATED = 'FAMILY_HISTORY_SELF_PARENT1 Survey Last Updated',
  FAMILY_HISTORY_FEMALE_PARENT_SURVEY_STATUS = 'FAMILY_HISTORY_SELF_PARENT1 Survey Status',
  ...
  FH_FEMALE_PARENT_AGE_RANGE = 'FH_PARENT1_AGE_RANGE',
  FH_FEMALE_PARENT_CANCERS_LIST = 'FH_PARENT1_CANCERS_LIST',
  FH_FEMALE_PARENT_HAD_CANCER = 'FH_PARENT1_HAD_CANCER',
  FH_MALE_PARENT_AGE_RANGE = 'FH_PARENT2_AGE_RANGE',
  FH_MALE_PARENT_CANCERS_LIST = 'FH_PARENT2_CANCERS_LIST',
  FH_MALE_PARENT_HAD_CANCER = 'FH_PARENT2_HAD_CANCER',
  ...
  H_E_PLURAL = 'H&E(s)',
  H_E_SINGULAR = 'H&E',
  HOW_HEAR_ABOUT_PROJECT = 'How did you hear about the project?',
  FULL_NAME = 'Full Name',
  GENDER = 'Gender',
