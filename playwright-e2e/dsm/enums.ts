...
export enum CustomizeViewID {
  PARTICIPANT_ID = 'data',
  PARTICIPANT_DSM_ID = 'p',
  MEDICAL_RECORD_ID = 'm',
  ONC_HISTORY_ID = 'oD',
  TISSUE_ID = 't',
  SAMPLE_ID = 'k',
  COHORT_TAG_ID = 'c',
  CLINICAL_ORDER_ID = 'cl',
  SURVEY_YOUR_CHILDS_OSTEOSARCOMA_ID = 'ABOUTCHILD',
  ADDITIONAL_CONSENT_ASSENT_LEARN_CHILDS_DNA_WITH_INVITAE_ID = 'GERMLINE_CONSENT_ADDENDUM_PEDIATRIC',
  BIOLOGICAL_PARENT_FEMALE_ID = 'FAMILY_HISTORY_SELF_PARENT1',
  RESEARCH_CONSENT_FORM_ADULT_ID = 'CONSENT',
  LOVED_ONE_SURVEY_ID = 'LOVEDONE',
  RESEARCH_CONSENT_ASSENT_FORM_ID = 'CONSENT_ASSENT',
  RESEARCH_CONSENT_FORM_PARENTAL_ID = 'PARENTAL_CONSENT',
  BIOLOGICAL_PARENT_MALE_ID = 'FAMILY_HISTORY_SELF_PARENT2',
  WHAT_WE_LEARNED_FROM_YOUR_DNA_ID = 'SOMATIC_RESULTS',
  HALF_SIBLING_ID = 'FAMILY_HISTORY_SELF_HALF_SIBLING',
  ADDITIONAL_CONSENT_LEARN_ABOUT_DNA_WITH_INVITAE_ID = 'GERMLINE_CONSENT_ADDENDUM',
  PROVIDE_CONTACT_INFORMATION_ID = 'CHILD_CONTACT',
  CHILD_ID = 'FAMILY_HISTORY_SELF_CHILD',
  MEDICAL_RELEASE_FORM_ADULT_ID = 'RELEASE_SELF',
  ADDITIONAL_DETAILS_ID = 'FAMILY_HISTORY_SELF_ADDITIONAL_DETAILS',
  ADD_CHILD_PARTICIPANT_ID = 'ADD_PARTICIPANT',
  SURVEY_FAMILY_HISTORY_OF_CANCER_ID = 'FAMILY_HISTORY_SELF',
  PREQUALIFIER_ID = 'PREQUAL',
  SURVEY_YOUR_OR_YOUR_CHILDS_OSTEOSARCOMA_ID = 'ABOUTYOU',
  GRANDPARENT_ID = 'FAMILY_HISTORY_SELF_GRANDPARENT',
  ADDITIONAL_CONSENT_ASSENT_LEARN_ABOUT_CHILD_TUMOR_ID = 'CONSENT_ADDENDUM_PEDIATRIC',
  SIBLING_ID = 'FAMILY_HISTORY_SELF_SIBLING',
  MEDICAL_RELEASE_FORM_PEDIATRIC_ID = 'RELEASE_MINOR',
  PARENTS_SIBLING_ID = 'FAMILY_HISTORY_SELF_PARENT_SIBLING',
  ADDITIONAL_CONSENT_LEARN_ABOUT_YOUR_TUMOR_ID = 'CONSENT_ADDENDUM',
  SURVEY_ABOUT_YOU_OR_YOUR_CHILD_ID = 'ABOUT_YOU_ACTIVITY',
  INVITAE_ID = 'OSTEO2_INVITAE_TAB',
  PROXY_ID = 'proxy',
  INVITATION_ID = 'invitations',
  CONTACT_INFORMATION_ID = 'address',
}
