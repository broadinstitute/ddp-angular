...
test.describe('Enroll myself as adult', () => {
  ...
  test('can complete self-enrollment @enrollment @singular', async ({ context, page, homePage }) => {
    ...
    await aboutMePage.fillInContactAddress({ fullName: `${user.patient.firstName} ${lastName}`,labels: { phone: 'Telephone Contact Number',country: 'Country',state:'State',zip:'Zip Code', city:'City'} });
