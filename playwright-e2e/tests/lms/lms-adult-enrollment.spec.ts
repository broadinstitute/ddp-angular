...
import AdditionalConsentPage from 'dss/pages/lms/additional-consent-page';
import HomePage from 'dss/pages/lms/home-page';
import GetStartedPage from 'dss/pages/lms/get-started-page';
import ResearchConsentPage from 'dss/pages/lms/research-consent-page';
import MedicalReleasePage from 'dss/pages/lms/medical-release-page';
import SurveyAboutLmsPage from 'dss/pages/lms/survey-about-lms-page';
...
test.describe.serial('LMS Adult Enrollment', () => {
  let researchConsentPage: ResearchConsentPage;
  let additionalConsentPage: AdditionalConsentPage;
  ...
  test('self-consent @visual @enrollment @lms', async ({ page }) => {
    researchConsentPage = new ResearchConsentPage(page);
    additionalConsentPage = new AdditionalConsentPage(page);
    ...
    await test.step('Asserting text contents on Additional Consent Form: Learning About Your Tumor', async () => {
      ...
      const additionalConsentPage = new AdditionalConsentPage(page);
      await additionalConsentPage.agreeToShareResults().check('Yes');
    ...
    await test.step('Asserting text contents on Survey: Your LMS', async () => {
      ...
      const surveyAboutLms = new SurveyAboutLmsPage(page);
