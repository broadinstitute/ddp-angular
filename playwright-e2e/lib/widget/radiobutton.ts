  ...
  constructor(page: Page, opts: { label?: string; ddpTestID?: string; root?: Locator | string; exactMatch?: boolean }) {
    ...
    this.rootLocator = root
      ? (typeof root === 'string'
        ...
        : root)
      : this.page.locator('mat-radio-group');
    ...
    this.elementLocator = ddpTestID
        ...
        : exactMatch
            ? this.rootLocator
                .locator(`xpath=.//mat-radio-button[.//input[@id=(//label[.//text()[normalize-space()="${label}"]]/@for)]]`)
            : this.rootLocator
                .locator(`xpath=.//mat-radio-button[.//input[@id=(//label[contains(normalize-space(.),"${label}")]/@for)]]`);
  }
