...
render_local_config() {
    ...
    INPUT_DIR=config IMAGE_NAME=$FINAL_IMAGE OUTPUT_DIR=$output_dir STUDY_KEY=$STUDY_KEY STUDY_GUID=$STUDY_GUID ENV=$ENV VERSION=$VERSION MANIFEST=manifest-study.rb OUTPUT_DIR=$output_dir DIR=$output_dir ruby ../ddp-study-server/pepper-apis/configure.rb -y
